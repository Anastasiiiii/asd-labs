...
char ProgName[]="Лабораторна робота 4 (2 частина)";
            ...
            printf("Connected matrix \n");
                ...
                for (int i = 0; i < n; i++){
                    for (int j = 0; j < n; j++) {
                        ...
                        if ((transA[i][j] == 1) && (reachA[i][j] == 1))
                        {matrix[i][j] = 1;} else if ((transA[i][j] == 0) && (reachA[i][j] == 0))
                        {matrix[i][j] = 0;} else if ((transA[i][j] == 0) && (reachA[i][j] == 1))
                        {matrix[i][j] = 0;} else if ((transA[i][j] == 1) && (reachA[i][j] == 0))
                        {matrix[i][j] = 1;}
                        printf ("%d ", matrix[i][j]);
                    }
                    printf("\n");
